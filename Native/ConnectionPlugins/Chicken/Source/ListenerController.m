...
- (void)updateUI
{
    ...
    [actionBtn setTitle: [[NSBundle bundleForClass:[ListenerController class]] localizedStringForKey:!active ? @"listenStart" : @"listenStop" value:!active ? @"listenStart" : @"listenStop" table:nil]];
    [statusText setStringValue: [[NSBundle bundleForClass:[ListenerController class]] localizedStringForKey:!active ? @"listenStopped" : @"listenRunning" value:!active ? @"listenStopped" : @"listenRunning" table:nil]];
...
+ (void)initPrefs
{
    [[NSUserDefaults standardUserDefaults] registerDefaults: 
        [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            [[NSBundle bundleForClass:[ListenerController class]] localizedStringForKey:@"defaultProfileName" value:@"defaultProfileName" table:nil],
...
- (void)loadProfileIntoView
{
    ...
    [profilePopup addItemWithTitle:[[NSBundle bundleForClass:[ListenerController class]] localizedStringForKey:@"EditProfiles" value:@"EditProfiles" table:nil]];
