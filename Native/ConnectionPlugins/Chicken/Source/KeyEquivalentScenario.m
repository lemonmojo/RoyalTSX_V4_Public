...
- (void)loadKeyEquivalentsFromMenu: (NSMenu *)menu
{
	...
	while ( menuItem = [menuEnumerator nextObject] )
	{
		...
		if ( characters && [characters length] )
		{
			...
			{
				NSUInteger modifiers = [menuItem keyEquivalentModifierMask];
				KeyEquivalent *equivalent = [[KeyEquivalent alloc] initWithCharacters: characters modifiers: (unsigned int)modifiers];
