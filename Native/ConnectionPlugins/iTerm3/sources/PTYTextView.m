...
// iTermLib Edit: Need this to properly handle control+arrow keys in Royal TSX
- (void)moveLeft:(id)sender
{
    [self lm_forwardMoveEvent:@"moveLeft:"];
}

// iTermLib Edit: Need this to properly handle control+arrow keys in Royal TSX
- (void)moveRight:(id)sender
{
    [self lm_forwardMoveEvent:@"moveRight:"];
}

// iTermLib Edit: Need this to properly handle control+arrow keys in Royal TSX
- (void)moveUp:(id)sender
{
    [self lm_forwardMoveEvent:@"moveUp:"];
}

// iTermLib Edit: Need this to properly handle control+arrow keys in Royal TSX
- (void)moveDown:(id)sender
{
    [self lm_forwardMoveEvent:@"moveDown:"];
}

// iTermLib Edit: Need this to properly handle control+arrow keys in Royal TSX
- (void)lm_forwardMoveEvent:(NSString*)eventName
{
    // iTermLib Edit: For debugging only
    //NSLog(@"%@ %@", eventName, NSThread.callStackSymbols);
