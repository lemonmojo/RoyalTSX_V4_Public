...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [self createSessionInParentView:self.placeholderViewFirstLeft withName:@"Session 01" andBackgroundColor:colorLeftTerminal transparency:0.5];
...
- (iTermLibSessionController*)createSessionInParentView:(NSView*)parentView withName:(NSString*)name andBackgroundColor:(NSColor*)backgroundColor transparency:(float)transparency
{
    ...
    if (transparency > 0) {
        ...
        // This however causes problems with PSMTabBarControl's rendering and likely other views
